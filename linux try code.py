    ...
    while not rospy.is_shutdown():
        ...
        if step2 == "dead":
            ...
            if b1 >= times_cnt or b2 >= times_cnt or b3 >= times_cnt:
                ...
                filename = img_cnt+".jpg"
                output_dir1 = "/home/pcms/catkin_ws/src/beginner_tutorials/src/m1_evidence/first"
                output_dir2 = "/home/pcms/catkin_ws/src/beginner_tutorials/src/m1_evidence/second"
                output_dir3 = "/home/pcms/catkin_ws/src/beginner_tutorials/src/m1_evidence/third"
                if(b1>=time_cnt): output_dir=output_dir1
                if (b2 >= time_cnt): output_dir=output_dir2
                if (b3 >= time_cnt): output_dir=output_dir3
